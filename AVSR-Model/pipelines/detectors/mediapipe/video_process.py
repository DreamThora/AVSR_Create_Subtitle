...
def cut_patch(img, landmarks, height, width, threshold=50):
    center_x, center_y = np.mean(landmarks, axis=0)
    # print(f"center_x : {abs(center_y - img.shape[0] / 2)}")
    # print(f"center_y : {abs(center_y - img.shape[0] / 2)}")
    # print(f"h : {height+threshold}")
    # print(f"w : {width+threshold}")
